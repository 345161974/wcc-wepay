...
* 
**/
require_once WCC_WEPAY_PLUGIN_PATH."lib/WxPay.Config.Interface.php";
...
class WxPayConfig extends WxPayConfigInterface
{
	...
	public function GetAppId()
	{
            ...
            //$payment_gateway    = $payment_gateways->payment_gateways()[WCC_WEPAY_GATEWAY_ID];
            
            // Method 2:
            $payment_gateway = WC()->payment_gateways->payment_gateways()[WCC_WEPAY_GATEWAY_ID];
            return $payment_gateway->app_id;
	}
	...
	**/
	...
	public function GetKey()
	{
            ...
            // Method 2:
            $payment_gateway = WC()->payment_gateways->payment_gateways()[WCC_WEPAY_GATEWAY_ID];
            return $payment_gateway->api_key;
	}
